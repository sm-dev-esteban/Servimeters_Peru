<div id="test-l-4" class="content">
              <h5 class="text-center p-3">Sistemas de gestión de calidad</h5>  
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>Escriba el documento que utiliza para el control de documentos y registros y el tratamiento de trabajos o productos no conformes. 
                    ...
                    <div class="col-md-6">
                     ...
                     <div class="col-md-6">
                      <div class="form-group">
                        <label>Escriba como la empresa realiza la planeación y programación del producto o servicio a homologar.</label>
                          <input type="text" class="form-control">
                      </div>
                    </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>Escriba como la empresa realiza el control de los procesos subcontratados asociados al producto o servicio a homologar.</label>
                          <input type="text" class="form-control">
                      </div>
                    </div>
                    ...
                    <div class="card card-default">
                     <div class="card-header">
                        ...
                        <ul>
                            <li class="nav-item">1. Certificado de Sistema de Gestión de Calidad (ISO 9001) que relacione el servicio o producto a homologar.</li>
                            ...
                            <li class="nav-item">4. Documento en el cual se han definido las competencias del personal que incluyan Cargo y Educación.</li>
                            <li class="nav-item">5. Plan o programa de mantenimiento y calibración de los equipos relacionados en la sección de capacidad operativa y que influyen en la calidad del servicio o producto a homologar</li>
                            <li class="nav-item">6. Procedimiento de evaluación de proveedores.</li>
                            <li class="nav-item">7. Procedimiento de inspección de productos, materiales o insumos comprados.</li>
                            <li class="nav-item">8. Procedimiento utilizado para realizar el control de calidad una vez finalizado el servicio el cual indique como afrontar retrasos en la fabricación de productos o servicios.</li>
                            <li class="nav-item">9. Resultado del análisis de los resultados de las evaluaciones de satisfacción del cliente.</li>
