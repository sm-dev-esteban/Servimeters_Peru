                  ...
                  <!--Campo Empresa-->
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="tradeName" class="form-control" id="exampleInputEmail1" placeholder="Enter email">
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                            <label for="exampleInputEmail1">RUC / CIF / NIF ( Por Favor especificar)</label>
                            <input type="text" name="nif" class="form-control" id="exampleInputEmail1" placeholder="Enter email">
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="taxResidence" class="form-control" id="exampleInputEmail1" placeholder="Enter email">
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="postalCode" class="form-control" id="exampleInputEmail1" placeholder="Enter email">
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label for="exampleInputEmail1">Providencia/Población/Pais</label>
                          <input type="text" name="country" class="form-control" id="exampleInputEmail1" placeholder="Enter email">
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Llenado por:</label>
                            <input type="text" name="filledBy" class="form-control" id="exampleInputEmail1" placeholder="Enter email">
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Actividad Económica(Código CIIU)</label>
                            <input type="text" name="economicActivity" class="form-control" id="exampleInputEmail1" placeholder="Enter email">
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label for="exampleInputEmail1">Escriba el tipo de servicio o producto a homologar, adicional, especifique si lo subcontrata.</label>
                          <input type="text" name="service" class="form-control" id="exampleInputEmail1" placeholder="Enter email">
                        </div>
                      </div>
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          <label for="exampleInputEmail1">Capital Social de la empresa en Dólares</label>
                          <input type="text" name="socialCapital" class="form-control" id="exampleInputEmail1" placeholder="Enter email">
                        </div>
                      </div>
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Número de clientes en los últimos dos años(2021/2022)</label>
                            <input type="text" name="numberCustomer" class="form-control" id="exampleInputEmail1" placeholder="Enter email">
                        </div>
                      </div>
                    ...
                    <div class="card card-default">
                     <div class="card-header">
                        ...
                        <ul>
                            <li class="nav-item">1. Certificado de Cámara y Comercio no mayor a 30 días.</li>
                            <li class="nav-item">2. Balance del último año junto con las notas.</li>
                            <li class="nav-item">4. En un solo archivo los últimos seis meses de pagos a ESSALUD.</li>
                            <li class="nav-item">5. En un solo archivo los últimos seis meses de pagos a APF / SNP.</li>
                            <li class="nav-item">6. En un solo archivo los últimos seis meses de planillas de personal.</li>
                            <li class="nav-item">7. En un solo archivo los últimos seis meses de CTS (Compensación por tiempo de servicio).</li>
                            <li class="nav-item">8. Declaración Antisoborno y procedencia de los fondos de la empresa firmada por el representante legal.</li>
                            <li class="nav-item">9. Declaración que establezca que la documentación entregada es legítima y que exime a SM por cualquier daño o perjuicio por la información suministrada firmada por el representante legal.</li>
                        </ul>
                    </div>
                    <div class="card-body">
                        <d iv id="actions" class="row">
                            <div class="col-lg-6">
              ...
              <div class="card">
                    <div class="card-body">
                      ...
                      <div class="row">
                          <div class="col-md-6">
                              <!-- Primera tabla -->
                              <label>1.1 En la siguiente tabla llene el volumen de ventas de los últimos tres años en dólares:</label>
